...
class BillOverview extends EnhancedStatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        if ($activeTab === 'paid') {
            return [
                EnhancedStatsOverviewWidget\EnhancedStat::make(translate('Total To Pay'), '-'),
                EnhancedStatsOverviewWidget\EnhancedStat::make(translate('Due Within 7 Days'), '-'),
                ...
                EnhancedStatsOverviewWidget\EnhancedStat::make(translate('Paid Last Month'), $lastMonthTotal)
